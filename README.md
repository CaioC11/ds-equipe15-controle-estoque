...
| :--- | :--- | :--- |
| **[Nome 1]** | Product Owner (PO) | Levantar requisitos, estruturar o Product Backlog e User Stories. |
...
| **[Nome 4]** | Desenvolvedor(a) / Requisitos | Mapeamento de causa-raiz, análise de stakeholders e documentação. |
| **[Nome 5]** | Desenvolvedor(a) / QA | Apoio na especificação de testes, validação de regras de negócio e dev. |
